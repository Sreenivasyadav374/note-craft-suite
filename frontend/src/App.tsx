                ...
                <BrowserRouter>
                  ...
                  >
                    <Routes>
                      ...
                      <Route path="/notes" element={<RequireAuth><LazyNotesApp /></RequireAuth>} />
                      <Route path="/calendar" element={<RequireAuth><LazyCalendarView /></RequireAuth>} />
                      <Route path="/" element={<RequireAuth><LazyNotesPage /></RequireAuth>} />
